...
You are to write a comprehensive implementation plan for the feature specified. Follow these guidelines:

## Context

Before writing the plan, make sure the context is clear. This should be written in a dedicated worktree. Use skill `use-git-worktree`
...
- Testing they need to perform
- Documentation they might need to check
- How to test it

Give them the whole plan as bite-sized tasks. Follow these principles:
